...
export default function JSONMinifier() {
  ...
  return (
    <ToolContainer
      title="JSON Minifier"
      description="Compress JSON data by removing all unnecessary whitespace."
    ...
    >
      <div className="space-y-6">
        ...
        {output && (
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Minified Output</label>
            <textarea
              readOnly
