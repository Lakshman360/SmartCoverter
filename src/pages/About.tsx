...
export default function About() {
  useEffect(() => {
    document.title = "About Us - ToolsMama";
  }, []);
    ...
    <div className="py-20 md:py-32 bg-slate-50 dark:bg-slate-900/50 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          ...
          <ValueCard icon={Heart} title="Always Free" desc="Every tool on ToolsMama is completely free, with no limits, no sign-up required." />
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
            ToolsMama was created with a simple goal: to provide useful, everyday tools that respect user privacy and require zero setup. No accounts, no cloud uploads, no subscriptions.
          </p>
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-12">
            We believe that utility tools should be simple, fast, and accessible to everyone. Whether you're a student, developer, designer, or just someone who needs to quickly convert a file — ToolsMama has you covered.
          </p>
...
function ValueCard({ icon: Icon, title, desc }: { icon: any; title: string; desc: string }) {
  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 text-center shadow-sm hover:border-blue-300 dark:hover:border-blue-700 transition-all hover:-translate-y-1">
      <div className="w-14 h-14 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-2xl flex items-center justify-center mx-auto mb-6">
        <Icon size={28} />
      </div>
