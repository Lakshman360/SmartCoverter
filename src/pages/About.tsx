...
export default function About() {
  useEffect(() => {
    document.title = "About Us - Zentoolbox";
  }, []);
    ...
    <div className="py-20 md:py-32 bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          ...
          <ValueCard icon={Heart} title="Always Free" desc="Every tool on Zentoolbox is completely free, with no limits, no sign-up required." />
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="text-slate-600 text-lg leading-relaxed mb-8">
            Zentoolbox was created with a simple goal: to provide useful, everyday tools that respect user privacy and require zero setup. No accounts, no cloud uploads, no subscriptions.
          </p>
          <p className="text-slate-600 text-lg leading-relaxed mb-12">
            We believe that utility tools should be simple, fast, and accessible to everyone. Whether you're a student, developer, designer, or just someone who needs to quickly convert a file — Zentoolbox has you covered.
          </p>
